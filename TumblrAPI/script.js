...
const apiKey = "bHolixoiLBbXMduB2Bp4gLIclrYS0q1siRCUHlmRuKROepfEIp";
...
function startGame() {
    ...
    let tagName = ['Birds','Insect','Animals','aliens'];
    ...
    fetch(`https://api.tumblr.com/v2/tagged?tag=${randomTag}&api_key=bHolixoiLBbXMduB2Bp4gLIclrYS0q1siRCUHlmRuKROepfEIp`)
        .then(response => {
